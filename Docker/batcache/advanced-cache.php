...
class batcache {
	...
	var $headers = array('memcached' => 'activated-by-praveen'); // Add headers here as name=>value or name=>array(values). These will be sent with every response from the cache.
